...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`sidebar-overlay ${isCollapsed ? "hidden" : ""}`}
      ...
      <div className={`sidebar ${isCollapsed ? "collapsed" : ""}`}>
        <div className="sidebar-header">
          <Link to="/" className="sidebar-logo">
            ...
            {!isCollapsed && (
              <span className="sidebar-logo-text">BlogPlatform</span>
            )}
          </Link>
              ...
              {user ? (
                <>
                  <li className="sidebar-menu-item">
                    <Link
                      to="/create-post"
                      className={`sidebar-menu-link ${isActive("/new-post")}`}
                    >
                      <span className="sidebar-menu-icon">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      {!isCollapsed && (
                        <span className="sidebar-menu-text">Write Post</span>
                      )}
                    </Link>
                  </li>
                  ...
                  <li className="sidebar-menu-item">
                    ...
                    >
                      ...
                      {!isCollapsed && (
                        <span className="sidebar-menu-text">Favorites</span>
                      )}
                    </Link>
                  </li>
                  ...
                  <li className="sidebar-menu-item">
                    ...
                    >
                      ...
                      {!isCollapsed && (
                        <span className="sidebar-menu-text">My Posts</span>
                      )}
                    </Link>
                  </li>
                  ...
                  {user.role === "admin" && (
                    <li className="sidebar-menu-item">
                      <Link
                        to="/admin"
                        className={`sidebar-menu-link ${isActive("/admin")}`}
                      >
                        <span className="sidebar-menu-icon">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <>
                  <li className="sidebar-menu-item">
                    <Link
                      to="/login"
                      className={`sidebar-menu-link ${isActive("/login")}`}
                    >
                      <span className="sidebar-menu-icon">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className="sidebar-menu-item">
                    <Link
                      to="/register"
                      className={`sidebar-menu-link ${isActive("/register")}`}
                    >
                      <span className="sidebar-menu-icon">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
